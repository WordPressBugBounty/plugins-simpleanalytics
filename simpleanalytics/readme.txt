...
Installing "Simple Analytics" can be done in multiple ways.
...
* Requires WordPress 7.0.3
* Requires PHP 7.4.0
* Changes:
* Use release app client ID (#53)
* Use release app for protected branch updates (#52)
* Execute the configured analytics load callback safely (#47)
* Preserve IP exclusions on their first save (#44)
* Preserve settings until the plugin is uninstalled (#45)
* Respect both states of automated event settings (#43)
* Fix manual pageview collection setting (#42)
* Update wp-env to fix PHP 7.4 CI (#49)


= 1.109 =
* 2026-07-20
* Tested up to WordPress 7.0.2
* Requires WordPress 6.9.4
* Requires PHP 7.2.0
...
* Release 1.103: Code updates


= 1.103 =
* 2026-04-06
* Changes:
* Release 1.102: Code updates


= 1.102 =
* 2026-03-30
* Changes:
* Release 1.101: Code updates


= 1.101 =
* 2026-03-23
* Changes:
* Release 1.100: Code updates and support for WordPress 6.9.4
...
* Changes:
* Release 1.99: Code updates


= 1.99 =
* 2026-03-09
* Changes:
* Release 1.98: Code updates


= 1.98 =
* 2026-03-02
* Changes:
* Release 1.97: Code updates


= 1.97 =
* 2026-02-23
* Changes:
* Release 1.96: Code updates


= 1.96 =
* 2026-02-16
* Changes:
* Release 1.95: Code updates and support for WordPress 6.9.1
...
* 2025-03-24
* Changes:
* Release 1.47: Code updates


= 1.47 =
* 2025-03-17
* Changes:
* Release 1.46: Code updates


= 1.46 =
* 2025-03-10
* Changes:
* Release 1.45: Code updates


= 1.45 =
* 2025-03-03
* Changes:
* Release 1.44: Code updates


= 1.44 =
* 2025-02-24
* Changes:
* Release 1.43: Code updates and support for WordPress 6.7.2
...
* 2025-02-10
* Changes:
* Release 1.41: Code updates


= 1.41 =
* 2025-02-03
* Changes:
* Release 1.40: Code updates
...
= 1.18 =
* 2024-02-05
* Upgraded to WordPress 6.4.3

= 1.17 =
* 2023-12-11
* Upgraded to WordPress 6.4.2

= 1.16 =
* 2023-11-13
* Upgraded to WordPress 6.4.1

= 1.15 =
* 2023-10-16
* Upgraded to WordPress 6.3.2
...
= 1.4 =
* 2019-06-12
* Use code how WordPress recommends it
...
= 1.2 =
* 2019-05-16
* Rename to "Simple Analytics Official Plugin"
